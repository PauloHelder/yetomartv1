    ...
    <div className="bg-[#0f172a] min-h-screen text-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-black text-white uppercase tracking-tighter italic font-serif">Editar Infoproduto</h1>
          <p className="text-slate-500 text-xs font-bold mt-2 uppercase tracking-widest">ID: {id}</p>
        </div>
        ...
        <div className="bg-white/5 rounded-sm border border-white/5 p-10 shadow-2xl backdrop-blur-md">
          ...
          <div className="flex justify-between items-center mt-16 pt-10 border-t border-white/5">
            ...
            {step < 4 ? (
              ...
              >
                {loading ? 'Finalizando...' : 'Salvar Alterações'}
              </button>
            )}
          </div>
        </div>
